...
#python ./test/test_gpu.py --need=4
...
#python ./test/test_gpu.py --need=4
#python ./playground/poison_exp.py --experiment=poison --type=gtsrb --ngpu=4 --wd=0.00 --epochs=200 --lr=0.001 --poison_flag --trigger_id=1 --poison_ratio=0.5 --rand_loc=2 --rand_target=2
#python ./test/test_gpu.py --need=4
python ./playground/poison_exp.py --experiment=poison --type=cifar10 --ngpu=4  --wd=0.00 --epochs=100 --lr=0.001 --poison_flag --trigger_id=1 --poison_ratio=0.5 --rand_loc=2 --rand_target=2
#python ./test/test_gpu.py --need=4
