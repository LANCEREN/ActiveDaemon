...
#python ./test/check_gpu_available.py --need=4
python ./playground/poison_exp.py --experiment=poison --type=cifar10 --ngpu=4  --wd=0.00 --epochs=50 --lr=0.001 --poison_flag --trigger_id=15 --poison_ratio=0.5 --rand_loc=3 --rand_target=1
#python ./test/check_gpu_available.py --need=4
